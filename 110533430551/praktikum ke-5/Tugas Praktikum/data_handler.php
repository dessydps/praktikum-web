...
/**
 *Fungsi utama untuk memanggil pengolahan data
	...
	if($res) {
		...
		if($num) {
			...
			<div class="tabel">
				...
				<table border=1 width=700 cellpading=4 cellspacing=0>
					<tr>
						<th>#</th>
						<th width=120>NIM</th>
					...
					while($row = mysql_fetch_row($res)){
						...
						<tr class="<?php echo $bg;?>">
							...
							| <a href="<?php echo $root;?>&amp;act=edit&amp;id=
								<?php echo $id;?>">
								Edit</a> |
							<!--kode PHP untuk membuat link hapus data-->
							| <a href="<?php echo $root;?>&amp;act=del&amp;id=
		...
		<?php
			...
			echo 'Belum ada data,
				isi <a href="'.$root.'&amp;act=add">disini</a>';
		}
		@mysql_close($res);
	}
}
...
/**
 *Fungsi untuk menghasilkan form penambahan atau pengubahan
 *@param string root parameter menu
 *@param integer id nim mahasiswa
*/
